...
use source_scan::{
    discover_jsonl_files, discover_recent_jsonl_candidates, is_pi_log_path, read_new_lines,
    source_roots_status_json, summarize_files, ScanSummary,
};
...
mod tests {
    use super::*;
    use crate::source_scan::{discover_jsonl_files_from, is_pi_session_jsonl};
    use std::io::Read;
    use std::path::Path;
